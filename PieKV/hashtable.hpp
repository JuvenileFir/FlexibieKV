...
public:
    ...
    void get_table(Bucket * bucket, uint64_t key_hash, const uint8_t *key, size_t key_length);
    void set_table(uint64_t key_hash, const uint8_t *key, size_t key_length);
